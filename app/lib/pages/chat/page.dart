      ...
      builder: (context, provider, connectivityProvider, child) {
        return Scaffold(
          ...
          body: GestureDetector(
            ...
            child: Stack(
              children: [
                // Messages fill the body so the floating chat bar's shadow
                // projects onto live chat content scrolling behind it.
                Positioned.fill(
                                  ...
                                  builder: (context, constraints) {
                                    return Theme(
                                      ...
                                      child: ListView.builder(
                                        ...
                                        // Reserve room at the bottom for the floating chat bar +
                                        // (optional) nav bar so the last message isn't hidden under them.
                                        padding: EdgeInsets.fromLTRB(
                                          18,
                                          16,
                                          18,
                                          textFieldFocusNode.hasFocus ? 96 : 200,
                                        ),
                ...
                // Bottom nav bar — rendered first so the chat bar (next sibling)
                // paints on top of it.
                if (!textFieldFocusNode.hasFocus)
                  Positioned(
                    left: 0,
                ...
                // Chat bar — floats over the messages list, overlapping the top
                // of the nav bar (matches the home page chat bar at bottom: 78).
                Positioned(
                  left: 0,
                  right: 0,
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Center(
                                                        child: FaIcon(
                                                          ...
                                                          color: voiceRecorderProvider.state ==
